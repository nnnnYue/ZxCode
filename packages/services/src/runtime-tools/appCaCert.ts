...
const APP_CA_CERT_FILE = "zxcode-network-ca.pem";
const APP_CA_KEY_FILE = "zxcode-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "ZxCode Network CA" },
    { name: "organizationName", value: "ZxCode" },
  ];
