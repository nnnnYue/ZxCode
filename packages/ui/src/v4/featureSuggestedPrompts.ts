...
// 推荐位插件图标一律用随包快照（scripts/fetch-official-marketplace.mjs 下载），
// 官方市场离线化后 UI 不再引用任何平台资源 URL。
import browserUseIcon from "@/assets/plugin-icons/official/browser-use.png";
