...
const zhCN: Record<string, string> = {
  ...
  "bots.title": "机器人",
  "bots.description": "把外部聊天工具和 Webhook 接入 ZxCode 机器人。",
  "bots.listTitle": "机器人",
  "bots.addBot": "新建机器人",
  ...
  "bots.setup.guide.weixin.create.2":
    "ZxCode 会直接保存 iLink 返回的 bot_token；扫码后请在微信里向 Bot 发送任意消息完成会话激活。",
  "bots.setup.guide.weixin.create.3":
    "ZxCode 内置 iLink 客户端，通过 `/ilink/bot/getupdates` 长轮询收消息，通过 `/ilink/bot/sendmessage` 回复。",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook 模式不需要先在第三方平台创建原生机器人；你的系统只需要能向 ZxCode 回调接口发消息。",
  ...
  "bots.setup.guide.webhook.bind.1": "向 ZxCode 的 `/api/bots/webhook` 发送一条私聊消息回调。",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere": "Telegram 长轮询由另一个 ZxCode 窗口处理。",
  ...
  "codeViewer.saved": "文件已保存",
  "codeViewer.saveFailed": "保存失败：{error}",
  "codeViewer.unsavedTitle": "未保存的更改",
  "codeViewer.unsavedDescription": "「{file}」有未保存的更改，关闭后将丢失。",
  "codeViewer.unsavedSaveAndClose": "保存并关闭",
  "codeViewer.unsavedDiscard": "直接离开",
  ...
  "webRemoteControl.description": "通过聊天机器人控制 ZxCode 工作区。",
  ...
  "settings.custom.headers.valuePlaceholder": "Header 值，例如 MyApp/1.0",
  ...
  "settings.custom.headers.incompleteRow": "请补全名称和值，或删除该行",
  "settings.custom.headers.maxEntriesReached": "最多支持 {count} 条请求头",
  ...
  "settings.mcp.failure.not_authenticated": "MCP 服务端要求身份验证，当前请求未通过。",
  "settings.mcp.failure.coding_plan_required":
    "MCP 服务端拒绝了当前访问权限，请检查该服务的可用性。",
  ...
  "settings.modelProvider.namePlaceholder": "如：My Provider",
  ...
  "chat.quota.mcp.codingPlanRequired":
    "ZxCode MCP「{server}」当前不可用，请稍后重试或检查该服务配置。",
  ...
  "zcode.error.providerBusiness.1006": "供应商认证已失效，请检查 Provider 配置或 API Key。",
  ...
  "settings.mobileRelay.enableDescription":
    "连接你自部署的 relay 服务器，用手机浏览器遥控本机工作区。",
  ...
  "settings.mobileRelay.serverUrlDescription":
    "自部署 relay 的地址，例如 https://relay.example.com；须先部署 packages/relay。",
  ...
  "settings.mobileRelay.grantDescription":
    "为当前工作区生成一次性授权链接（10 分钟内有效、仅可使用一次），手机扫码或打开链接即可接入。",
