...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-zxcode-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "zxcode:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "zxcode:workspace-file-drag-state";
