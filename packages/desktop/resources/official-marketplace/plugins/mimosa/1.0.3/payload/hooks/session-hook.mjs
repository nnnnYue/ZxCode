...
loader.loadProtectedScript(join(here, "session-hook.mjs.mimosa"), "mimosa/af8b4e5393f28ec0b00d678d/zcode-hook/session-hook.mjs", join(here, "session-hook.engine.cjs"));
