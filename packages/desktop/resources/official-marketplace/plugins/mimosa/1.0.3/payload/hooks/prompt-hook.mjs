...
loader.loadProtectedScript(join(here, "prompt-hook.mjs.mimosa"), "mimosa/af8b4e5393f28ec0b00d678d/zcode-hook/prompt-hook.mjs", join(here, "prompt-hook.engine.cjs"));
