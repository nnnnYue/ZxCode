...
All three are **remote HTTP MCP servers on ZxCode's own gateway** (`${ZXCODE_BASE_URL}`),
...
there and must not be edited here. The ZxCode adaptation layer (manifests, this README,
