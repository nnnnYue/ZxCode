    ...
    "tts_generate": {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "preferred_provider": {"type": "string", "enum": ["auto", "cloud", "cloud_tts"], "default": "auto"},
                "allowed_providers": {"type": "array", "items": {"type": "string", "enum": ["cloud_tts"]}},
                "retries": {
                    "type": "integer",
                    "minimum": 0,
                    "maximum": 10,
...
SPEECH_SYNTHESIZE_SCHEMA = {
    ...
    "inputSchema": {
        ...
        "properties": {
            ...
            "preferred_provider": {
                "type": "string",
                "enum": ["auto", "cloud", "cloud_tts"],
                "default": "auto",
            },
            "allowed_providers": {
                "type": "array",
                "items": {"type": "string", "enum": ["cloud", "cloud_tts"]},
            },
...
for _name in ("synthesize_narration", "soccer_tts", "lol_tts"):
    ...
    if isinstance(_schema, dict):
        ...
        if isinstance(_props.get("provider"), dict):
            _props["provider"]["enum"] = ["auto", "cloud", "cloud_tts"]
