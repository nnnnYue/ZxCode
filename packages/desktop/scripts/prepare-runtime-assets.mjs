...
const shouldSkipRemoteAssets = process.env.ZXCODE_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (ZXCODE_SKIP_REMOTE_ASSETS=1)");
}
