...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "zxcode";
export const DEV_ELECTRON_APP_NAME = "ZxCode Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.zxcode.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 zxcode URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 zxcode 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".zxcode-dev-electron-source.json");
