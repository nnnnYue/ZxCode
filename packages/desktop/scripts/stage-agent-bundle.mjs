// Agent bundle 的暂存动作：把 apps/zcode-cli/packages/cli/dist/zxcode.cjs 放进
...
export const AGENT_BUNDLE_SOURCE_RELATIVE = "apps/zcode-cli/packages/cli/dist/zxcode.cjs";
...
export function resolveAgentBundlePaths({ repoRoot, platformKey }) {
  ...
  return {
    ...
    glmDir,
    stagedBundlePath: resolve(glmDir, "zxcode.cjs"),
 ...
 * （zxcode-agent / zxcode-acp 等）和旧 meta 会被一并打进安装包（CI 干净检出不会有，本地会）。
 */
