...
{
    private const string Protocol = "ZXCODE_BROWSER_IMPORT_V1";
        ...
        try
        {
            if (HasArgument(args, "--version"))
            {
                ...
                Console.Out.WriteLine(
                    "ZXCODE_BROWSER_IMPORT_HELPER\t" + HelperVersion + "\t" + GetProcessArchitecture() +
    ...
    private static void RunBrokerCore()
    {
        ...
        try
        {
            ...
            pipeName = "zxcode-browser-import-broker-" + Guid.NewGuid().ToString("N");
            token = CreateToken();
        ...
        int brokerPid)
    {
        ...
        string pipeName = "zxcode-browser-import-system-" + Guid.NewGuid().ToString("N");
