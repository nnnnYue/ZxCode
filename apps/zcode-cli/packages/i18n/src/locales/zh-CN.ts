...
`,
  ...
  tui: {
    ...
    loginRequired: {
      help: "输入 /model 查看模型，或在设置中配置 Provider。",
      message: "没有可用模型，请在设置中配置 Provider。",
      status: "没有可用模型，请在设置中配置 Provider。",
      title: "需要配置模型",
    },
    model: {
    ...
    terminal: {
      starting: "正在启动 ZxCode… Ctrl+C 退出",
