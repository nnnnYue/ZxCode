...
`,
  ...
  tui: {
    ...
    loginRequired: {
      help: "Use /model to view models, or configure a provider in settings.",
      message: "No available models. Configure a provider in settings.",
      status: "No available models. Configure a provider in settings.",
